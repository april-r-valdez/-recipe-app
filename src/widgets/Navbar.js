        ...
        <div className="navbar fixed-top bg-body-tertiary flex-nowrap" data-bs-theme="light">
            <div className="container-fluid">
                ...
                <div className="d-flex">
                    ...
                    <IoIosSearch className="p-1 me-2 icon-bg-light rounded-circle" style={{ fontSize: '30px'}}
                        onClick={() => openModal({
                    ...
                    <FaCircleUser className="p-1 me-2 icon-bg-light rounded-circle" style={{ fontSize: '30px'}} 
                        onClick={() => openModal({
