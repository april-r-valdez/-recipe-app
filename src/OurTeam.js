            ...
            <div className="row">
                ...
                <div className="col-4">
                    <div class="card text-bg-secondary ms-md-4">
                        ...
                        <img src="https://mdbcdn.b-cdn.net/img/new/avatars/8.webp" class="rounded-circle mb-3 mx-auto" style={{width: '150px' }} alt="Avatar" />
                        <div class="card-body">
                            <h5 class="card-title mb-3" style={{ color: 'white' }}><strong>Jeffrey Hsu</strong></h5>
                            <h6 class="card-subtitle mb-4 text-body-secondary">Full-Stack Software Developer</h6>
                            <p class="card-text" style={{ color: 'white' }}>
                                Jeff is proficient in React.js, HTML, and CSS. 
                                He enjoys working closely with cross-functional teams, including designers 
                                and back-end developers, to transform ideas into functional and visually appealing digital solutions.
                                His focus is on creating synergy between design and functionality.
                            </p> 
                        </div>
                        <br></br>
                    </div>
